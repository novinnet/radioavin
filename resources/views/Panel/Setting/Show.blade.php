            ...
            <form id="add-plan" method="post" action="{{route('Panel.Setting')}}">
                ...
                <div class="row">
                    <div class="col-md-12">
                        <h6>فهرست ها</h6>
                        <div class="custom-control custom-checkbox custom-control-inline">
                                     <input type="checkbox" id="menu1" name="menu" value="music"
                                        class="custom-control-input" checked>
                                    <label class="custom-control-label" for="menu1">
                                        music</label>
                                </div>
                                 <div class="custom-control custom-checkbox custom-control-inline">
                                     <input type="checkbox" id="video" name="menu" value="video"
                                        class="custom-control-input" checked>
                                 ...
                                 <div class="custom-control custom-checkbox custom-control-inline">
                                     <input type="checkbox" id="Slider" name="menu" value="Slider"
                                        class="custom-control-input" checked>
                                    <label class="custom-control-label" for="Slider">
                                        Slider</label>
                                </div>
                                  <div class="custom-control custom-checkbox custom-control-inline">
                                     <input type="checkbox" id="Photos" name="menu" value="Photos"
                                        class="custom-control-input" checked>
                                 ...
                                 <div class="custom-control custom-checkbox custom-control-inline">
                                     <input type="checkbox" id="footer" name="menu" value="footer"
                                        class="custom-control-input" checked>
