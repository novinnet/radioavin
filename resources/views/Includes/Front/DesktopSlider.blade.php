            ...
            <div class="swiper-wrapper">
                <div class="swiper-slide">
                    <div class="slider-box">
                        ...
                        <img class="slider-back-img" src="{{asset('frontend/assets/images/slider/p1.jpg')}}" alt="">
                        <div class="movie-details-box-slider">
                            <a href="#">
                                <img src="{{asset('frontend/assets/images/slider/slider-detail-1.png')}}" alt="">
                            </a>
                            <h4>
                                اسم فیلم
                            </h4>
                ...
                <div class="swiper-slide">
                    <div class="slider-box">
                        <div class="shadow-bottom-slider"></div>
                        <img class="slider-back-img" src="{{asset('frontend/assets/images/slider/p2.jpg')}}" alt="">
                        <div class="movie-details-box-slider">
                            <a href="#">
                                <img src="{{asset('frontend/assets/images/slider/slider-detail-1.png')}}" alt="">
                            </a>
                ...
                <div class="swiper-slide">
                    <div class="slider-box">
                        <div class="shadow-bottom-slider"></div>
                        <img class="slider-back-img" src="{{asset('frontend/assets/images/slider/p3.jpg')}}" alt="">
                        <div class="movie-details-box-slider">
                            <a href="#">
                                <img src="{{asset('frontend/assets/images/slider/slider-detail-1.png')}}" alt="">
                            </a>
