														...
														<td align="center" valign="top" width="500" class="flexibleContainerCell">
															...
															<table border="0" cellpadding="30" cellspacing="0" width="100%">
																<tr>
                                                                    ...
                                                                    <div style="text-align:center;font-family:Helvetica,Arial,sans-serif;font-size:15px;margin-bottom:0;color:#205478;line-height:135%;">تخفیف ویژه {{$percent}} درصدی برای اشتراک {{$plans->first()->name}} در نظر گرفته شد شما تا تاریخ {{$date}} فرصت دارید تا از این تخفیف استفاده نمایید</div>
																	</td>
																</tr>
															</table>
															<!-- // CONTENT TABLE -->
														...
														<td style="padding-top:0;" align="center" valign="top" width="500" class="flexibleContainerCell">
															...
															<table border="0" cellpadding="0" cellspacing="0" width="50%" class="emailButton" style="background-color: #3498DB;">
																<tr>
                                                                    ...
                                                                    <a style="color:#FFFFFF;text-decoration:none;font-family:Helvetica,Arial,sans-serif;font-size:20px;line-height:135%;" target="_blank" href="{{$baseurl}}">مشاهده</a>
																	</td>
																</tr>
															</table>
															<!-- // CONTENT TABLE -->
