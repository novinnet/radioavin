                    ...
                    <div class="col-md-8">
                        ...
                        <div class="row">
                            <div class="form-group col-md-12">
                                ...
                                <input type="text" class="form-control" name="name" onblur="checkName(event,'<?php echo e(route('Panel.checkNameAjax')); ?>')" id="original-title"
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('Layout.Panel', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\radio\resources\views/Panel/Series/add.blade.php ENDPATH**/ ?>