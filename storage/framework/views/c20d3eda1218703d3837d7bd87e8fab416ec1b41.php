																			...
																			<tr>
																				<td align="left" class="textContent">
																					<div style="font-family:Helvetica,Arial,sans-serif;font-size:13px;color:#828282;text-align:center;line-height:120%;">
																						 یک اشتراک جدید در سایت قرار گرفت 
																					</div>
																				</td>
																			</tr>
																		</table>
																		...
																		<table border="0" cellpadding="0" cellspacing="0" width="100%" style="max-width:100%;">
																			<tr>
																				<td align="left" class="textContent">
																					<!-- CONTENT // -->
																					<div style="font-family:Helvetica,Arial,sans-serif;font-size:13px;color:#828282;text-align:center;line-height:120%;">
																						این ایمیل از طرف , <a href="#" target="_blank" style="text-decoration:none;border-bottom:1px solid #828282;color:#828282;"><span style="color:#828282;">sione</span></a> برای شما ارسال شده است.
																					</div>
																				</td>
																			</tr>
																		</table>
															...
															<table border="0" cellpadding="30" cellspacing="0" width="100%">
																<tr>
																	...
																	<img alt="logo" src="https://genebartar.ir/assets/images/logo.jpeg">
																		...
																		<h1 style="color:#FFFFFF;line-height:100%;font-family:Helvetica,Arial,sans-serif;font-size:35px;font-weight:normal;margin-bottom:5px;text-align:center;">sione</h1>
																		<h2 style="text-align:center;font-weight:normal;font-family:Helvetica,Arial,sans-serif;font-size:23px;margin-bottom:10px;color:#205478;line-height:135%;">برترین فیلم ها و سریال های جهان</h2>
                                                                    <div style="text-align:center;font-family:Helvetica,Arial,sans-serif;font-size:15px;margin-bottom:0;color:#205478;line-height:135%;">تخفیف ویژه <?php echo e($percent); ?> درصدی برای اشتراک <?php echo e($plans->first()->name); ?> در نظر گرفته شد شما تا تاریخ <?php echo e($date); ?> فرصت دارید تا از این تخفیف استفاده نمایید</div>
																	</td>
																</tr>
															</table>
															<!-- // CONTENT TABLE -->
															...
															<table border="0" cellpadding="0" cellspacing="0" width="50%" class="emailButton" style="background-color: #3498DB;">
																<tr>
																	<td align="center" valign="middle" class="buttonContent" style="padding-top:15px;padding-bottom:15px;padding-right:15px;padding-left:15px;">
																		<a style="color:#FFFFFF;text-decoration:none;font-family:Helvetica,Arial,sans-serif;font-size:20px;line-height:135%;" target="_blank">مشاهده</a>
																	</td>
																</tr>
															</table>
															<!-- // CONTENT TABLE -->
...
<?php /**PATH C:\xampp\htdocs\tm\resources\views/emails/newdiscount.blade.php ENDPATH**/ ?>