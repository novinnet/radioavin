                    ...
                    <tr>
                        <td>
                            <div class="custom-control custom-checkbox custom-control-inline"
                                ...
                                <input data-id="<?php echo e($plan->id); ?>" type="checkbox" id="post_<?php echo e($key); ?>"
                        ...
                        <td>
                            <a href="<?php echo e(route('Panel.EditPlan',$plan)); ?>" class="btn btn-sm btn-info">ویرایش</a>
                        </td>
...
<script>
    $('table input[type="checkbox"]').change(function(){
     ...
     $('.deleteposts').click(function(e){
            ...
            url='<?php echo e(route('Panel.DeletePlan')); ?>';
