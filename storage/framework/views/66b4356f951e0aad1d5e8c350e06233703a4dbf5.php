                    ...
                    <div class="details-song-inner" style="display: none">
                        <div class="contentInner">
                            <div class="mp3Description">
                                ...
                                <div pubdate="pubdate" class="dateAdded">Released: <?php echo e(\Carbon\Carbon::parse($post->released)->format('Y/m/d')); ?></div>
                            </div>
...
<script src="<?php echo e(asset('frontend/assets/Generic-Mobile-friendly-Slider-Plugin-with-jQuery-touchSlider/jquery.touchSlider.js')); ?>"></script>
    ...
    let track_list =JSON.parse(<?php echo json_encode($track_lists, 15, 512) ?>)
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('Layout.Front', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\radio\resources\views/Front/show.blade.php ENDPATH**/ ?>